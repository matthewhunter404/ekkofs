...
export class PermissionsController {
    ...
    async findAll(): Promise<PermissionDto[]> {
      return (await this.permissionsService.findAll()).map(e =>PermissionDto.fromEntity(e));
    }
    ...
    async create(@Body() createPermissionDto: CreatePermissionDto): Promise<PermissionDto> {
      ...
      const createdPermission = await this.permissionsService.create(createPermissionDto.toEntity());
